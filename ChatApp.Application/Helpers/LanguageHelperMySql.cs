...
{
    public class LanguageHelperMySql : ILanguageHelper
    {
        public LanguageHelperMySql(IConfiguration configuration, ICacheService cacheService)
        {
            ConnectionString = configuration.GetConnectionString("MySql") ?? throw new Exception("ConnectionString was not provided for LanguageHelperMySql.");
