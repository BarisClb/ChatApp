...
{
    public class LanguageHelperPostgreSql : ILanguageHelper
    {
        public LanguageHelperPostgreSql(IConfiguration configuration, ICacheService cacheService)
        {
            ConnectionString = configuration.GetConnectionString("PostgreSql") ?? throw new Exception("ConnectionString was not provided for LanguageHelperPostgreSql.");
